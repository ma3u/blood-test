...
const NegativeFactorsTable: React.FC = () => {
  ...
  const headers = t('sections.factors.negativeTable.headers', { returnObjects: true }) as string[];
  const rows = t('sections.factors.negativeTable.rows', { returnObjects: true }) as string[][];
