...
const NegativeFactorsTable: React.FC = () => {
  ...
  const headers: string[] = t('sections.factors.negativeTable.headers', { returnObjects: true });
  const rows: string[][] = t('sections.factors.negativeTable.rows', { returnObjects: true });
  return (
